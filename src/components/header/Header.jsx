...
import "./header.css";
import NavLogo from "../../assets/by.zyan.png";
        ...
        <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
          <ul className="nav__me">
            ...
            <li className="nav__list grid">
              ...
              >
                <i class="uil uil-bolt nav__icon"></i> Skills
              </a>
            </li>
            <li className="nav__list grid">
              <a
              ...
              >
                <i class="uil uil-location-arrow nav__icon"></i> Experience
              </a>
            </li>
            <li className="nav__list grid">
              <a
              ...
              >
                <i class="uil uil-message nav__icon"></i> References
              </a>
            </li>
          </ul>
          <i
